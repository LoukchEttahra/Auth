...
)),),Positioned(left: 249.103,width: 27.034,top: 0,height: 27.404,child: Container(decoration: BoxDecoration(), child:SvgPicture.asset('assets/images/profileicon.svg', package: 'arabic',width: widget.constraints.maxWidth * 0.052,height: widget.constraints.maxHeight * 0.409, fit: BoxFit.none,)),),Positioned(left: 167.034,width: 27.034,top: 0,height: 27.404,child: ,),Positioned(left: 124.552,width: 27.034,top: 0,height: 27.404,child: Container(decoration: BoxDecoration(), child:SvgPicture.asset('assets/images/againicon.svg', package: 'arabic',width: widget.constraints.maxWidth * 0.070,height: widget.constraints.maxHeight * 0.442, fit: BoxFit.none,)),),Positioned(left: 3.862,width: 26.069,top: 0,height: 27.404,child: Container(decoration: BoxDecoration(), child:Container(decoration: BoxDecoration(), child:Stack(
children: [Positioned(left: 5.793,width: 9.655,top: 14.681,height: 4.894,child: SvgPicture.asset('assets/images/vector1.svg', package: 'arabic',width: widget.constraints.maxWidth * 0.034,height: widget.constraints.maxHeight * 0.106, fit: BoxFit.none,),),Positioned(left: 0,width: 21.241,top: 13.181,height: 1.5,child: SvgPicture.asset('assets/images/line1.svg', package: 'arabic',width: widget.constraints.maxWidth * 0.076,height: widget.constraints.maxHeight * 0.033, fit: BoxFit.none,),),Positioned(left: 1.931,width: 17.379,top: 0,height: 11.745,child: Container(width: widget.constraints.maxWidth * 0.062,height: widget.constraints.maxHeight * 0.255,decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(2)),border: Border.all(width: 1.5,),),),),]))),),]),),]));
  }
